System.register(['angular2/core', 'angular2/router', './pagination.component', './Column.component', '../Services/SLA.service'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            SLAComponent = (function (_super) {
                ...
                SLAComponent.prototype.ngOnInit = function () {
                    ...
                    this._SLAService.getSLAs().then(function (res) {
                        _this.SLAs = res.SLAs;
                        _this.total = res.total;
                    });
                };
                SLAComponent.prototype.currentPageChange = function (event) {
                    var _this = this;
                    this._SLAService.getSLAs((event.page - 1) * event.itemsPerPage, event.itemsPerPage).then(function (res) {
                        _this.SLAs = res.SLAs;
                        _this.total = res.total;
                    });
                };
